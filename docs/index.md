...
SlideCraft does not integrate tracking analytics or advertisements that harvest your personal data. The app is built using the Flutter framework and utilizes open-source plugins (such as `image_picker` and `file_picker`), which only interact with Android and iOS system APIs to fulfill the requested actions.

## Changes to this Privacy Policy
We may update our Privacy Policy occasionally to reflect updates to our application. Any changes will be posted in this document. 

## Contact
If you have any questions or suggestions about our Privacy Policy, please open an issue in the project's repository.
